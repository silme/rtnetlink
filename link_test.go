...
func TestLinkMessageMarshalBinary(t *testing.T) {
	...
	var val_string_ipip string = "ipip"
	var val_OperationalState_OperStateUp OperationalState = OperStateUp
		...
		},
		{
			...
			m: &LinkMessage{
				Attributes: &LinkAttributes{
					...
					Broadcast:        []byte{255, 255, 255, 255},
					Name:             &val_string_ipip,
					OperationalState: &val_OperationalState_OperStateUp,
				},
			},
			b: []byte{
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		...
		},
		{
			...
			m: &LinkMessage{
				Attributes: &LinkAttributes{
					...
					OperationalState: &val_OperationalState_OperStateUp, // uint8 (6)
